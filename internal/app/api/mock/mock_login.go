...
// @Path /api/v1/pub/login/captchaid [get]
...
// @Path /api/v1/pub/login/captcha [get]
...
// @Path /api/v1/pub/login/exit [post]
...
// @Failure 500 {object} schema.ErrorResult "{error:{code:0,message:服务器错误}}"
// @Path /api/v1/pub/refresh-token [post]
...
// @Failure 401 {object} schema.ErrorResult "{error:{code:0,message:未授权}}"
// @Failure 500 {object} schema.ErrorResult "{error:{code:0,message:服务器错误}}"
// @Path /api/v1/pub/current/user [get]
...
// @Failure 401 {object} schema.ErrorResult "{error:{code:0,message:未授权}}"
// @Failure 500 {object} schema.ErrorResult "{error:{code:0,message:服务器错误}}"
// @Path /api/v1/pub/current/menutree [get]
...
// @Failure 401 {object} schema.ErrorResult "{error:{code:0,message:未授权}}"
// @Failure 500 {object} schema.ErrorResult "{error:{code:0,message:服务器错误}}"
// @Path /api/v1/pub/current/password [put]
